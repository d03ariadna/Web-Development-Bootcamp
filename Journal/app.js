...
app.get("/posts/:postId", (req, res) => {
    // index = req.params.topic;
    let reqT = ((req.params.postId));
    Post.findOne({_id: reqT}, (err, pFound) => {
        if(!err){
            if(pFound){
                console.log("Match founded");
                postFound = pFound;
                res.redirect("/post");
                //res.render("postB", {titles: postFound.title, bodys: postFound.body});
            }else{
